...
public class Registro extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbusuario.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(cbusuario, javax.swing.GroupLayout.Alignment.LEADING, 0, 201, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(133, 133, 133)
...
try {
    ...
    if(archivo.ready()){
        ...
        //asignar usuarios 
           ...
           cbusuario.insertItemAt(nombre, pp);
            pp=pp+1;
        }
...
for (int i = 0; i < 5; i++) {
    ...
    if(i==pos){
        escritor.println(pos+pipol+","+"10,10,10,100,0:10:10,10,10,10,100,0:10:10");
    }else{
        escritor.println(i+","+nombres[i]+","+pgT[i]+","+ppT[i]+","+paT[i]+","+mmT[i]+","+tiempoT[i]+","+pgD[i]+","+ppD[i]+","+paD[i]+","+mmD[i]+","+tiempoD[i]);
...
String pipol;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        pipol =nombre.getText();
        cbusuario.removeItemAt(pos);
        cbusuario.insertItemAt(pipol, pos);
        int tn=10-pipol.length();
        if(pipol.length()<10){
            for (int i = 0; i <=tn; i++) {
                pipol+=" ";
